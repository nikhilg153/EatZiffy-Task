    ...
    <div className="section">
      <div className="section__label">
        ...
        <ul>
          ...
          <Link className="link" to="/cooking">
            <li className="item2">Burger</li>
          </Link>
      ...
      <div className="section__menu">
        <div className="section__menucard">
          <img src="https://images.unsplash.com/photo-1474600056930-615c3d706456?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1052&q=80" />
          <span>Al-Fungi Pizza</span>
        ...
        <div className="section__menucard">
          <img src="https://images.unsplash.com/photo-1513104890138-7c749659a591?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80" />
          <span>Pizza with burries</span>
          <div className="icons1">
